...
public class FindDogs extends Frame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == exitButton) {
            ...
            for (File file : files) {
                ...
                if(coincidenceCount > maxCoincidence) {
                    maxCoincidence = coincidenceCount;
                    maxIdx = idx;
                }
            ...
            if(files.size() > 0) {
                System.out.println("OPENNING c:/code/java/aiprp/lab1/files/"+files.get(maxIdx).getName());
                openInBrowser("c:/code/java/aiprp/lab1/files/"+files.get(maxIdx).getName());
            }
        }
    }
